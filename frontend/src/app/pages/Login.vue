...
const oauthBaseUrl = import.meta.env.VITE_OAUTH_BASE_URL || apiBaseUrl
...
const loginWithFacebook = () => {
  window.location.href = `${oauthBaseUrl}/auth/facebook`
}
...
// Reset to login form when Header's Login button is clicked (changes ?t= param)
watch(() => route.query.t, () => {
  isLogin.value = true
  error.value = ''
})
    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 sm:p-10 border border-gray-100 dark:border-gray-700">
        ...
        <div class="grid grid-cols-2 gap-3 mb-6">
          <button @click="loginWithGoogle" class="flex items-center justify-center gap-2 py-3 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 active:scale-95 transition-all text-sm text-gray-600 dark:text-gray-300" :style="{ fontWeight: 600 }">
          ...
          <button @click="loginWithFacebook" class="flex items-center justify-center gap-2 py-3 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 active:scale-95 transition-all text-sm text-gray-600 dark:text-gray-300" :style="{ fontWeight: 600 }">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            <div class="flex items-center justify-between mb-1.5">
              ...
              <router-link v-if="isLogin" to="/forgot-password" class="text-xs text-green-600 hover:text-green-700" :style="{ fontWeight: 500 }">Forgot password?</router-link>
            </div>
            <div class="relative">
