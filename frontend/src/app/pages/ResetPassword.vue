...
import { ArrowLeft, Lock, Eye, EyeOff, AlertCircle, CheckCircle } from 'lucide-vue-next'
    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 sm:p-10 border border-gray-100 dark:border-gray-700">
        ...
        <div v-if="success" class="text-center">
          ...
          <h2 class="text-lg text-gray-900 dark:text-white mb-2" :style="{ fontWeight: 700 }">Password Reset!</h2>
          <p class="text-gray-500 dark:text-gray-400 text-sm mb-6">
            Your password has been reset successfully. You can now sign in with your new password.
          </p>
          <button
            @click="router.push('/login')"
            class="w-full py-3.5 rounded-xl bg-green-600 hover:bg-green-700 text-white text-sm text-center transition-all shadow-md shadow-green-200 active:scale-95"
        ...
        <template v-else>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            <div>
              <label class="block text-xs text-gray-600 dark:text-gray-400 mb-1.5" :style="{ fontWeight: 600 }">New Password</label>
              <div class="relative">
            ...
            <div>
              <label class="block text-xs text-gray-600 dark:text-gray-400 mb-1.5" :style="{ fontWeight: 600 }">Confirm Password</label>
              <div class="relative">
                <Lock class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                <input
                  :type="showPassword ? 'text' : 'password'"
            ...
            <button
              ...
              :class="[
                ...
                loading || !token ? 'bg-green-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700 active:scale-95'
              ]"
              :style="{ fontWeight: 700 }"
            >
